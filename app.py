...
from dashboard.theme_config import THEME, get_streamlit_css, get_aqi_status, get_aqi_recommendation, AQI_STATUS_MAP
from reporting.report_generator import ProfessionalReportGenerator
...
def main():
    ...
    # Load Data Button
    if st.sidebar.button("Load Data", width='stretch'):
        load_all_data()
